...
export default function SignUpScreen() {
  ...
  const validateForm = (): boolean => {
    ...
    if (password.length < 4) {
      Alert.alert(
        ...
        t("register.error.passwordTooShort")
      );
      return false;
    }
    ...
    if (password !== repeatPassword) {
      Alert.alert(
        t("register.error.title"),
        t("register.error.passwordsDoNotMatch")
      );
      return false;
    }
      ...
      if (response.success) {
        ...
        Alert.alert(
          ...
          t(
            ...
            "A confirmation link has been sent to your email address. Please check your inbox and click the link to activate your account."
          ),
          [
            {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.text}>{t("register.title")}</Text>
      <StyledInput
        value={email}
