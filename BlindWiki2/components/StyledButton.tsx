...
const styles = StyleSheet.create({
  ...
  buttonRaised: {
    ...
    elevation: 5,
    borderWidth: 1,
    borderTopColor: Colors.light.button.border,
    borderLeftColor: Colors.light.button.border,
    borderRightColor: Colors.light.button.border,
    borderBottomWidth: 3,
    borderBottomColor: Colors.light.button.borderBottom,
  },
  buttonPressed: {
    shadowColor: Colors.light.button.shadow,
